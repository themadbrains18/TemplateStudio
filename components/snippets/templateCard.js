        ...
        <>
            <div className='template_card border-[1px] border-divider-main'>
                <div className='relative'>
                    ...
                    <a href='/' className='overlay_text font-open-sans font-bold text-white text-[18px] flex gap-2 absolute  left-[50%] top-[50%] -translate-x-2/4 -translate-y-2/4 opacity-0 transition duration-500 ease-in-out'>
                        View Detals
