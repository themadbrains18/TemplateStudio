        ...
        <>
            <div className="">
                ...
                {isActive && <div className="dropdown_content">
                    ...
                    <h2 className='main-heading !text-[18px] pl-[6px] border-l-[1.5px] !leading-7 border-[#5D5775] rounded-[4px] text-red-50 bg-gradient-to-r from-[#F5EAFD] ... '>Feature Product</h2>
