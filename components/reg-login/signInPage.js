    ...
    return (
        <>
            <div className='grid grid-cols-1 justify-items-center xmd:grid-cols-2  '>
                <div className='bg-reg-bg w-full h-[374px] xmd:h-[700px] flex flex-col justify-between py-[50px] px-5 xmd:px-[100px] xl:h-[1080px] '>
                    <Image src={regLogo} width={276} height={40} alt='image error' />
                    <p className='font-open-sans font-normal text-[32px] xmd:text-[62px] text-white max-w-[900px] w-full text-center'>Free High-quality UI kits and design resources</p>
                    <p className='text-white font-open-sans font-medium text-[14px]'>By Madbrains Technologies LLP.</p>
                </div>

                <div className='flex flex-col justify-between  py-[40px] px-5 xmd:py-[50px] xmd:px-[100px] max-w-[960px] w-full bg-white'>
                    ...
                    <div className='mb-[30px] xmd:mb-0'>
                        ...
                        <div className=" mr-4 inline-block min-h-[1.5rem] pl-[1.5rem] mb-[30px] xmd:mb-[60px]">
