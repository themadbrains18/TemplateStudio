                        ...
                        <div className='mb-[30px] lg:mb-0'>
                            <ul className='mb-5 lg:mb-[30px]'>
                                <li className='mb-5 lg:mb-[30px]'>
                                    ...
                                    <input {...register("name")} type='text' placeholder='Name' className='py-[14px] px-5 outline-none border border-divider-main w-full block bg-primary-800' />
                            ...
                            <div className='text-right mb-[30px] lg:mb-[60px]'>
                                <button type="submit" className={`solid-btn w-full !py-[13px] text-[18px] mb-5 ${isLoading===true?'opacity-[0.4]':'opacity-[1]'}`} disabled={isLoading}>Create Account</button>
